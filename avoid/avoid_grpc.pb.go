...
func (c *tunnelClient) ListConnections(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListReply, error) {
	out := new(ListReply)
	err := c.cc.Invoke(ctx, "/avoid.Tunnel/ListConnections", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) GetStats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsReply, error) {
	out := new(StatsReply)
	err := c.cc.Invoke(ctx, "/avoid.Tunnel/GetStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) Migrate(ctx context.Context, in *MigrateRequest, opts ...grpc.CallOption) (*MigrateReply, error) {
	...
	err := c.cc.Invoke(ctx, "/avoid.Tunnel/Migrate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tunnelClient) Shutdown(ctx context.Context, in *ShutdownRequest, opts ...grpc.CallOption) (*ShutdownReply, error) {
	out := new(ShutdownReply)
	err := c.cc.Invoke(ctx, "/avoid.Tunnel/Shutdown", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTunnelServer) Shutdown(context.Context, *ShutdownRequest) (*ShutdownReply, error) {
...
func _Tunnel_ListConnections_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/avoid.Tunnel/ListConnections",
	}
...
func _Tunnel_GetStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/avoid.Tunnel/GetStats",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Tunnel_Migrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/avoid.Tunnel/Migrate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Tunnel_Shutdown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShutdownRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TunnelServer).Shutdown(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/avoid.Tunnel/Shutdown",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TunnelServer).Shutdown(ctx, req.(*ShutdownRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Tunnel_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Shutdown",
			Handler:    _Tunnel_Shutdown_Handler,
		},
		{
			MethodName: "Register",
